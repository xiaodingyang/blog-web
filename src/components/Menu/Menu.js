...
export class Menue extends Component {
  ...
  render() {
    ...
    return (
      <Style className="nav">
        <div className="nav-toggle" onClick={this.show}>
          <Button type="default" icon="menu-unfold" ghost>
            MENU
          </Button>
        </div>
        ...
        {this.state.toggle && (
          <div
            ref="nav"
            className="nav-container animated rollIn"
            style={{ background: `url(${navImg[bg]}) no-repeat center/cover` }}
          >
            <Scrollbars>
